...
void Patches() {
    ...
    PATCH_SWITCH("0x1836BF8", "40B29AD2A0C9A0F2E019DEF20090E8F2C0035FD6", freeItems); 
	PATCH_SWITCH("0x183686C", "40B29AD2A0C9A0F2E019DEF20090E8F2C0035FD6", freeItems); 
	PATCH_SWITCH("0x1838E00", "40B29AD2A0C9A0F2E019DEF20090E8F2C0035FD6", freeItems); 
    PATCH_SWITCH("0x1836684", "40B29AD2A0C9A0F2E019DEF20090E8F2C0035FD6", freeItems); 
